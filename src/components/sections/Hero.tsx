        ...
        <div className="lg:hidden relative min-h-screen flex items-end ">
          ...
          <div className="relative z-10 text-left px-6 py-8 w-full">
            ...
            <p className="text-sm md:text-base text-white mb-6 font-regular leading-relaxed drop-shadow-md">
              Si necesitas aprender cómo solicitar un crédito o cómo solucionar
              un problema con tus créditos o cómo ganarle al banco, llegaste al
              lugar correcto
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="lg:hidden space-y-6">
            ...
            {bottomStats.map((stat, index) => (
              <div key={index} className="bg-[#6C55D7] rounded-2xl p-6 mx-2">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 pt-4 px-4">
              <button
                onClick={handleDownload}
                className="bg-[#EB5523] hover:bg-[#d44a1f] text-white px-8 py-4 rounded-lg text-base font-semibold transition-colors w-full">
                Descarga la app
              </button>
              <button
                onClick={handleWebApp}
                className="bg-white hover:bg-white/70 text-black px-8 py-4 rounded-lg text-base font-semibold transition-colors w-full">
                Ingresar
              </button>
            </div>
          </div>
